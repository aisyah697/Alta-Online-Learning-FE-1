    ...
    <React.Fragment>
      <Grid container spacing={3}>
        ...
        <Grid item xs={6} className={classes.viewProfile}>
          <Link
            href={"/admin/profile/[admin_name]/edit"}
            as={`/admin/profile/${admin.username}/edit`}
          >
            <Button
      ...
      <Grid container spacing={3}>
        ...
        >
          ...
          <div className={classes.text}>
            <Typography className={classes.name}>{admin.full_name}</Typography>
            <Typography className={classes.email}>{admin.email}</Typography>
          </div>
        </Grid>
        <Grid item xs={12}>
          <TableContainer>
