...
export default function EditQuizSubject({quiz}) {
  ...
  const [values, setValues] = React.useState({name: quiz.name, description: quiz.description });
  ...
  const postEditQuiz = async () => {
    setOpen(false);
    const url = process.env.NEXT_PUBLIC_BASE_URL + `/quiz/${quiz.id}`;
